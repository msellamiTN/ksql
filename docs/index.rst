...
Getting started
   - :ref:`ksql_quickstart`: Demonstrates a simple workflow using KSQL to write streaming queries against data in Kafka.
   - :ref:`ksql_clickstream`: Shows how to analyze data feeds and build a real-time dashboard for reporting and alerting.
